...
const PlaceItem = props => {
    ...
    const [showMap, setShowMap] = useState(false);  //map state
    ...
    const confirmDeleteHandler = async () => {    //to delete a place
        setShowConfirmModal(false);
        try{
            await sendRequest(
            ...
            console.log("Printing auth in Delete request - PlaceItem.js");
